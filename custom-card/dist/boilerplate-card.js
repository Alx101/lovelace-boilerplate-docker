...
let BoilerplateCardEditor = /** @class */ (() => {
...
let BoilerplateCard = /** @class */ (() => {
    let BoilerplateCard = class BoilerplateCard extends LitElement {
        ...
        setConfig(config) {
            ...
            this._config = Object.assign({ name: 'Boilerplate' }, config);
        }
